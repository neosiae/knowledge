...
Sometimes you want to create a method that belongs to a class rather than an object so you don't have to create an instance of the class to access it. These methods are called static methods.
